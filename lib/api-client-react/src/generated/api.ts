...
export const createShareLink = async (id: number,
  ...
  return customFetch<ShareResponse>(getCreateShareLinkUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getCreateShareLinkMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createShareLink>>, TError,{id: number;data?: BodyType<CreateShareRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createShareLink>>, TError,{id: number;data?: BodyType<CreateShareRequest>}, TContext> => {
...
const {mutation: mutationOptions, request: requestOptions} = options ?
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createShareLink>>, {id: number;data?: BodyType<CreateShareRequest>}> = (props) => {
          const {id,data} = props ?? {};
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateShareLinkMutationBody = BodyType<CreateShareRequest> | undefined
...
export const useCreateShareLink = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createShareLink>>, TError,{id: number;data?: BodyType<CreateShareRequest>}, TContext>, request?: SecondParameter<typeof customFetch>}
        ...
        TError,
        {id: number;data?: BodyType<CreateShareRequest>},
        TContext
      > => {
...
export const getGetSharedVideoUrl = (token: string,) => {
  ...
  return `/api/videos/shared/${token}`
}

/**
 * @summary Get a shared video by token
 */
export const getSharedVideo = async (token: string, options?: RequestInit): Promise<SharedVideoResponse> => {

  return customFetch<SharedVideoResponse>(getGetSharedVideoUrl(token),
  {
    ...options,
    method: 'GET'
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetSharedVideoQueryKey(token);
   ...
   return  { queryKey, queryFn, enabled: token !== null && token !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getSharedVideo>>, TError, TData> & { queryKey: QueryKey }
}
...
export const getRecordAnalyticsUrl = (id: number,) => {
 ...
 */
export const recordAnalytics = async (id: number,
    analyticsEvent: AnalyticsEvent, options?: RequestInit): Promise<MessageResponse> => {

  return customFetch<MessageResponse>(getRecordAnalyticsUrl(id),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getRecordAnalyticsMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof recordAnalytics>>, TError,{id: number;data: BodyType<AnalyticsEvent>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof recordAnalytics>>, TError,{id: number;data: BodyType<AnalyticsEvent>}, TContext> => {

const mutationKey = ['recordAnalytics'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof recordAnalytics>>, {id: number;data: BodyType<AnalyticsEvent>}> = (props) => {
          const {id,data} = props ?? {};

          return  recordAnalytics(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type RecordAnalyticsMutationResult = NonNullable<Awaited<ReturnType<typeof recordAnalytics>>>
    export type RecordAnalyticsMutationBody = BodyType<AnalyticsEvent>
    export type RecordAnalyticsMutationError = ErrorType<unknown>

    /**
 * @summary Record a video analytics event
 */
export const useRecordAnalytics = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof recordAnalytics>>, TError,{id: number;data: BodyType<AnalyticsEvent>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof recordAnalytics>>,
        TError,
        {id: number;data: BodyType<AnalyticsEvent>},
        TContext
      > => {
      return useMutation(getRecordAnalyticsMutationOptions(options));
    }
